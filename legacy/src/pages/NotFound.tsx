  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4">
      ...
      <div className="relative z-10 w-full max-w-[760px] rounded-[32px] gf-panel p-8 text-center shadow-[0_24px_56px_rgba(8,14,30,0.28)] sm:p-10">
        ...
        <h1 className="mt-5 text-6xl font-extrabold tracking-[-0.04em] text-foreground">404</h1>
        <p className="mt-4 text-xl font-semibold text-foreground">That page does not exist in this workspace.</p>
        <p className="mx-auto mt-3 max-w-xl text-[0.98rem] leading-7 text-muted-foreground">
          The route <span className="font-mono text-foreground/80">{location.pathname}</span> could not be resolved. Return to the main intake flow or jump back into your dashboard.
        </p>
