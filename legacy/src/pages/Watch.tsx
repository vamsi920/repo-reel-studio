    ...
    return (
      <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background">
        ...
        <div className="relative rounded-[24px] gf-panel-glass px-8 py-7 text-center shadow-[0_24px_56px_rgba(8,14,30,0.28)]">
          ...
          <p className="mt-4 text-[0.95rem] text-muted-foreground">Loading private watch link...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background p-6">
        ...
        <div className="relative w-full max-w-[520px] rounded-[28px] gf-panel p-8 text-center shadow-[0_24px_56px_rgba(8,14,30,0.28)]">
          ...
          <h1 className="mt-5 text-2xl font-semibold text-foreground">Video not found</h1>
        ...
        <div className="mx-auto flex max-w-[1440px] items-center justify-between gap-4 px-4 py-3 sm:px-6 xl:px-8">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <div className="text-[0.9rem] text-muted-foreground">{project.manifest.scenes.length} scenes • {durationLabel}</div>
            </div>
          </div>
      ...
      <main className="relative mx-auto max-w-[1440px] px-4 py-6 sm:px-6 xl:px-8">
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_320px]">
          <section className="overflow-hidden rounded-[28px] gf-panel p-4 shadow-[0_24px_56px_rgba(8,14,30,0.28)]">
            <div className="mb-4 flex flex-wrap items-center justify-between gap-4 rounded-[22px] bg-[linear-gradient(135deg,rgba(104,132,255,0.08),rgba(255,255,255,0.6),rgba(107,216,203,0.06))] px-5 py-4">
              <div>
                <div className="text-[11px] font-semibold uppercase tracking-[0.24em] text-primary">
                  Private watch route
                </div>
                <div className="mt-2 text-xl font-semibold text-foreground">Playback-ready walkthrough</div>
              </div>
            ...
            <section className="rounded-[26px] gf-panel p-5 shadow-[0_20px_48px_rgba(8,14,30,0.24)]">
              ...
              <div className="mt-4 space-y-3">
                <div className="rounded-[18px] bg-muted px-4 py-3">
                  ...
                  <div className="mt-1 text-[0.95rem] font-medium text-foreground">{project.repo_name}</div>
                </div>
                <div className="rounded-[18px] bg-muted px-4 py-3">
                  <div className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground">Access</div>
                  <div className="mt-1 text-[0.95rem] leading-6 text-foreground/80">
                    This route is protected by account ownership, so only the project owner can open it after sign-in.
                  </div>
                </div>
                <div className="rounded-[18px] bg-muted px-4 py-3">
                  <div className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground">Next step</div>
                  <div className="mt-1 text-[0.95rem] leading-6 text-foreground/80">
