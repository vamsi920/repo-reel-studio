...
// NeoDevEx modification: upstream's deprecated `applyDagreLayout` was removed
// here along with its `@dagrejs/dagre` import. Upstream already routes every
// structural view through `applyElkLayout` (./elk-layout); keeping the dagre
// fallback would have added a dependency nothing in NeoDevEx calls.
