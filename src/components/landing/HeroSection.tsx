...
export const HeroSection = ({ mousePos = { x: 0.5, y: 0.5 } }: { mousePos?: MousePos }) => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-gradient-to-r from-primary/30 to-purple-500/20 rounded-full blur-3xl animate-float opacity-60" />
      <div className="absolute bottom-1/3 right-1/4 w-[400px] h-[400px] bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-full blur-3xl animate-float opacity-50" style={{ animationDelay: "-3s" }} />
      <div className="absolute top-1/2 right-1/3 w-[300px] h-[300px] bg-gradient-to-r from-pink-500/15 to-primary/15 rounded-full blur-3xl animate-float opacity-40" style={{ animationDelay: "-5s" }} />

      <div className="container relative mx-auto px-4 py-20 md:py-32">
        <div className="flex flex-col items-center text-center max-w-5xl mx-auto">
          {/* Gemini Badge - Prominent */}
          <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-gradient-to-r from-primary/20 via-purple-500/20 to-cyan-500/20 border border-primary/30 text-sm mb-8 animate-fade-in backdrop-blur-sm">
            <div className="relative flex items-center gap-2">
              ...
              <span className="font-bold bg-gradient-to-r from-primary via-purple-400 to-cyan-400 bg-clip-text text-transparent">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-[1.1] mb-6 animate-fade-in-up">
            Transform Any{" "}
            <span className="relative inline-block">
              <Github className="inline-block h-12 md:h-16 lg:h-20 w-12 md:w-16 lg:w-20 text-white/90" />
            </span>{" "}
            Repository Into a{" "}
            ...
            <div className="relative">
              ...
              >
                ...
                <Button
                  variant="hero"
                  size="lg"
                  className="shrink-0 gap-2 bg-gradient-to-r from-primary to-purple-500 hover:from-primary/90 hover:to-purple-500/90 shadow-lg shadow-primary/25"
