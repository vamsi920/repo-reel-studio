...
export const agentOpsFocusVisibleClass =
  "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a1020]";

export const agentOpsRadioFocusClass =
  "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-300/55 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a1020]";
