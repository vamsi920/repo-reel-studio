    ...
    >
      ...
      {count > 0 ? (
        <span
          ...
          className="inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-foreground px-1 text-[11px] font-semibold leading-none text-[var(--oh-background)]"
        >
          {count}
        </span>
      ) : null}
