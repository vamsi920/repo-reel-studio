...
export const COLOR_THEMES: Record<ColorThemeKey, ColorThemeDefinition> = {
  "openhands-deepsea": {
    ...
    // Values generated by heroui() from hero.ts (light theme) — restore them
    // explicitly when switching back from another theme.
    heroui: {
      "--heroui-background": "213.33 36% 95.1%",
      "--heroui-background-foreground": "216 33.33% 2.94%",
      "--heroui-foreground-50": "216 45.45% 97.84%",
      "--heroui-foreground-100": "213.33 36% 95.1%",
      "--heroui-foreground-200": "216.67 34.62% 89.8%",
      "--heroui-foreground-300": "216 26.32% 81.37%",
      "--heroui-foreground-400": "216.36 21.85% 70.39%",
      "--heroui-foreground-500": "217.5 14.16% 55.69%",
      "--heroui-foreground-600": "219.38 14.04% 44.71%",
      "--heroui-foreground-700": "221.38 16.2% 35.1%",
      "--heroui-foreground-800": "222.5 17.65% 26.67%",
      "--heroui-foreground-900": "224.21 17.76% 20.98%",
      "--heroui-foreground": "224.21 17.76% 20.98%",
      "--heroui-content1": "216.67 34.62% 89.8%",
      "--heroui-content1-foreground": "220 29.03% 6.08%",
      "--heroui-content2": "216 26.32% 81.37%",
      "--heroui-content2-foreground": "222.86 17.5% 15.69%",
      "--heroui-content3": "216.36 21.85% 70.39%",
      "--heroui-content3-foreground": "224.21 17.76% 20.98%",
      "--heroui-content4": "217.5 14.16% 55.69%",
      "--heroui-content4-foreground": "222.5 17.65% 26.67%",
      "--heroui-default-50": "216 45.45% 97.84%",
      "--heroui-default-100": "213.33 36% 95.1%",
      "--heroui-default-200": "216.67 34.62% 89.8%",
      "--heroui-default-300": "216 26.32% 81.37%",
      "--heroui-default-400": "216.36 21.85% 70.39%",
      "--heroui-default-500": "217.5 14.16% 55.69%",
      "--heroui-default-600": "219.38 14.04% 44.71%",
      "--heroui-default-700": "221.38 16.2% 35.1%",
      "--heroui-default-800": "222.5 17.65% 26.67%",
      "--heroui-default-900": "224.21 17.76% 20.98%",
      "--heroui-default-foreground": "216 33.33% 2.94%",
      "--heroui-default": "216.36 21.85% 70.39%",
    },
  },
